...
class CVMPipeline:
    ...
    def run_initial_ingestion(self, start_date: str, end_date: str, max_workers: int = None) -> bool:
        """
        ...
        try:
            ...
            downloaded_files = self.downloader.download_range(
                start_date, end_date, max_workers
            )
    ...
    def run_monthly_update(self, include_current_month: bool = False) -> bool:
        """
        ...
        try:
            ...
            for month in months_to_download:
                file_path = self.downloader.download_single_month(month)
                if file_path:
